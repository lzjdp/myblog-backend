...
var ProFormUploadButton = function ProFormUploadButton(_ref, ref) {
  ...
  var showUploadButton = max === undefined || !value || (value === null || value === void 0 ? void 0 : value.length) < max;
  ...
  }), showUploadButton && /*#__PURE__*/_react.default.createElement(_button.default, null, icon, title));
};

var _default = (0, _BaseForm.createField)(_react.default.forwardRef(ProFormUploadButton), {
