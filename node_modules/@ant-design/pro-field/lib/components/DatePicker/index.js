...
var FieldDatePicker = function FieldDatePicker(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement("span", {
      ref: ref
    }, (0, _moment.default)(text).format(format) || '-');
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var momentValue = (0, _proUtils.parseValueToMoment)(value, format);
    ...
    if (light) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_datePicker.default, _extends({}, fieldProps, {
        picker: picker,
        showTime: showTime,
        format: format,
        ref: ref,
      ...
      _dom = /*#__PURE__*/_react.default.createElement(_datePicker.default, _extends({}, fieldProps, {
        picker: picker,
        showTime: showTime,
        format: format,
        placeholder: placeholder,
...
var _default = _react.default.forwardRef(FieldDatePicker);
