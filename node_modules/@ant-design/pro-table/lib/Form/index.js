...
var getFormCompetent = function getFormCompetent(isForm, searchConfig) {
  if (!isForm && searchConfig !== false) {
    if ((searchConfig === null || searchConfig === void 0 ? void 0 : searchConfig.filterType) === 'light') {
      return {
        Competent: _proForm.LightFilter,
        competentName: 'light-filter'
      };
    }

    return {
      Competent: _proForm.QueryFilter,
      competentName: 'query-filter'
    };
  }

  return {
    Competent: _proForm.default,
    competentName: 'form'
  };
};
/**
...
var FormSearch = function FormSearch(_ref3) {
  ...
  var transformKeyRef = (0, _react.useRef)({}); // 这么做是为了在用户修改了输入的时候触发一下子节点的render
          ...
          switch (_context.prev = _context.next) {
            ...
            case 12:
              if (onSubmit && valueTypeRef.current) {
                ...
                finalValue = (0, _proUtils.transformKeySubmitValue)((0, _proUtils.conversionSubmitValue)(value, dateFormatter, valueTypeRef.current), transformKeyRef.current);
  ...
  (0, _proUtils.useDeepCompareEffect)(function () {
    ...
    counter.proColumns.forEach(function (item) {
      var key = item.key,
          ...
          search = item.search,
          hideInSearch = item.hideInSearch;
      (0, _warning.default)(typeof hideInSearch !== 'boolean', "'hideInSearch' will be deprecated, please use 'search'"); // 以key为主,理论上key唯一

      var finalKey = (0, _utils.genColumnKey)(key || dataIndex, index); // 如果是() => ValueType
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)(className, (_classNames = {}, _defineProperty(_classNames, formClassName, isForm), _defineProperty(_classNames, getPrefixCls("pro-table-search-".concat(competentName)), true), _classNames))
  }, /*#__PURE__*/_react.default.createElement(Competent, _extends({}, loadingProps, getFromProps(isForm, searchConfig, competentName), formConfig, {
    form: form,
