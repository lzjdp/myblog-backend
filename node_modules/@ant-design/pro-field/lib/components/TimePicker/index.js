...
var FieldTimePicker = function FieldTimePicker(_ref, ref) {
  ...
  var valueStr = text ? (0, _moment.default)(text).format(format) : '';
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_datePicker.default.TimePicker, _extends({}, fieldProps, {
        format: format,
        ref: ref,
      ...
      _dom = /*#__PURE__*/_react.default.createElement(_datePicker.default.TimePicker, _extends({
        ref: ref,
        format: format,
...
var _default = _react.default.forwardRef(FieldTimePicker);
