...
import './index.less';
export var StepsFormProvide = React.createContext(undefined);
...
var StepsForm = function StepsForm(props) {
  ...
  var current = props.current,
      ...
      rest = _objectWithoutProperties(props, ["current", "onCurrentChange", "submitter", "stepsFormRender", "stepsRender", "stepFormRender", "stepsProps", "onFinish", "formProps"]);
  ...
  var formDom = toArray(props.children).map(function (item, index) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      key: name
    }, React.cloneElement(item, _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, config), formProps), itemProps), {}, {
      name: name,
      step: index,
      key: name
    })));
