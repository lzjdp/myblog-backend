...
var FieldDatePicker = function FieldDatePicker(_ref, ref) {
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var momentValue = parseValueToMoment(value, format);
    ...
    if (light) {
      ...
      }, /*#__PURE__*/React.createElement(_DatePicker, _extends({}, fieldProps, {
        picker: picker,
        showTime: showTime,
        format: format,
        ref: ref,
      ...
      _dom = /*#__PURE__*/React.createElement(_DatePicker, _extends({}, fieldProps, {
        picker: picker,
        showTime: showTime,
        format: format,
        placeholder: placeholder,
