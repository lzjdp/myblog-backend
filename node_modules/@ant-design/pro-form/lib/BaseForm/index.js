...
function createField(Field, config) {
  var FieldWithContext = function FieldWithContext(props) {
    ...
    var size = (0, _react.useContext)(_SizeContext.default);
    ...
    var field = /*#__PURE__*/_react.default.createElement(Field, _extends({}, rest, {
    ...
    return /*#__PURE__*/_react.default.createElement(_form.default.Item, _extends({
      ...
      ,
      label: label && (proFieldProps === null || proFieldProps === void 0 ? void 0 : proFieldProps.light) !== true ? /*#__PURE__*/_react.default.createElement(_proUtils.LabelIconTip, {
        label: label,
        tooltip: tooltip || tip
      }) : undefined,
      valuePropName: valuePropName
    }, defaultFormItemProps, formItemProps, restFormItemProps), /*#__PURE__*/_react.default.createElement(_LightWrapper.default, _extends({}, realFieldProps, {
      bordered: bordered,
      size: size,
...
var BaseForm = function BaseForm(props) {
  ...
  var formRef = (0, _react.useRef)(userForm || form);
  ...
  var submitterNode = submitter === false ? undefined : /*#__PURE__*/_react.default.createElement(_Submitter.default, _extends({}, submitterProps, {
    form: userForm || form
  }));
  ...
  return (
    ...
    _react.default.createElement(_proProvider.ConfigProviderWrap, null, /*#__PURE__*/_react.default.createElement(_FieldContext.default.Provider, {
      value: {
    ...
    }, /*#__PURE__*/_react.default.createElement(_SizeContext.default.Provider, {
      value: rest.size
      ...
      onFinish: function onFinish(values) {
        if (rest.onFinish) {
          rest.onFinish((0, _proUtils.conversionSubmitValue)(values, dateFormatter, fieldsValueType.current));
        }
      }
