...
function _getConfig() {
  _getConfig = _asyncToGenerator(function* (opts) {
    ...
    webpackConfig.module.rule('js').test(/\.(js|mjs|jsx|ts|tsx)$/).include.add(cwd).end().exclude.add(/node_modules/).end().use('babel-loader').loader(require.resolve('babel-loader')).options(babelOpts); // umi/dist/index.esm.js 走 babel 编译
