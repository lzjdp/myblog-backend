...
import FiledSelect, { proFieldParsingText, proFieldParsingValueEnumToArray } from './components/Select';
...
var defaultRenderText = function defaultRenderText(text, valueType, props) {
  ...
  if (valueType === 'select' || props.valueEnum || props.request) {
    return /*#__PURE__*/React.createElement(FiledSelect, _extends({
      text: text
    }, props));
  }
...
var ProField = function ProField(_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, defaultRenderText(text, valueType, _objectSpread(_objectSpread({}, rest), {}, {
    mode: rest.mode || 'read',
    ref: ref,
