          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  current = counter.action.current; // 如果为 true，回到第一页
                  ...
                  _context.next = 4;
                  return current === null || current === void 0 ? void 0 : current.resetPageIndex();

                case 4:
                  _context.next = 6;
                  return current === null || current === void 0 ? void 0 : current.reload();
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  current = counter.action.current; // reload 之后大概率会切换数据，清空一下选择。
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  _context3.next = 3;
                  return current === null || current === void 0 ? void 0 : current.reset();
