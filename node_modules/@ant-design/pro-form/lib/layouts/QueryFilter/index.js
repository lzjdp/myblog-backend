...
var QueryFilter = function QueryFilter(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_BaseForm.default, _extends({}, rest, {
    style: style,
    ...
    contentRender: function contentRender(items, renderSubmitter) {
      ...
      if (submitter) {
        submitter = _react.default.cloneElement(submitter, _objectSpread({
          searchConfig: {
            resetText: resetText,
      ...
      items.forEach(function (item, index) {
        ...
        var colSize = _react.default.isValidElement(item) ? (item === null || item === void 0 ? void 0 : (_item$props2 = item.props) === null || _item$props2 === void 0 ? void 0 : _item$props2.colSize) || 1 : 1;
        ...
        itemsWithInfo.push({
          span: colSpan,
          element: item,
          key: _react.default.isValidElement(item) ? item.key || "".concat(((_item$props3 = item.props) === null || _item$props3 === void 0 ? void 0 : _item$props3.name) || index, "-").concat(index, "}") : index,
          hidden: hidden
        });
      }); // for split compute
      ...
      return /*#__PURE__*/_react.default.createElement(_rcResizeObserver.default, {
        ...
        if (_react.default.isValidElement(item.element) && item.hidden) {
          return _react.default.cloneElement(item.element, {
            hidden: true,
            key: item.key || index
          });
        }
        ...
        if (split && currentSpan % 24 === 0 && index < lastVisibleItemIndex) {
          return [colItem, /*#__PURE__*/_react.default.createElement(_divider.default, {
            key: "line",
            style: {
              marginTop: -8,
              marginBottom: 16
        ...
        return colItem;
      }), submitter && /*#__PURE__*/_react.default.createElement(_col.default, {
        span: spanSize.span,
