...
exports.default = exports.proFieldParsingValueEnumToArray = exports.proFieldParsingText = exports.ObjToMap = void 0;
...
var proFieldParsingText = function proFieldParsingText(text, valueEnumParams, pure) {
...
var FieldSelect = function FieldSelect(props, ref) {
  ...
  if (mode === 'read') {
    if (loading) {
      return /*#__PURE__*/_react.default.createElement(_spin.default, null);
    }
    ...
    var dom = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, proFieldParsingText(rest.text, ObjToMap(optionsValueEnum || valueEnum)));
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      _dom = /*#__PURE__*/_react.default.createElement(_LightSelect.default, _extends({
        loading: loading,
        ref: inputRef,
        allowClear: true,
        size: size
      ...
      _dom = /*#__PURE__*/_react.default.createElement(_select.default, _extends({
        style: {
          minWidth: 100
        },
        loading: loading,
...
var _default = _react.default.forwardRef(FieldSelect);
