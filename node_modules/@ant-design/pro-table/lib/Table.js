...
var columnRender = function columnRender(_ref) {
  ...
  var textDom = (0, _defaultRender.default)(renderTextStr, item.valueType || 'text', index, row, columnEmptyText, item, type);
  ...
  return !(0, _proUtils.isNil)(dom) ? dom : null;
};
/**
 * render 的 title
 * @param item
...
var ProTable = function ProTable(props) {
  ...
  var manualRequestRef = (0, _react.useRef)(manualRequest);
  /**
   * 需要初始化 不然默认可能报错
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              responseData = (0, _utils.postDataPipeline)(response.data, [postData].filter(function (item) {
                return item;
              }));
  ...
  (0, _utils.useActionType)(actionRef, counter, function () {
    // 清空选中行
  ...
  var searchNode = (search !== false || type === 'form') && /*#__PURE__*/_react.default.createElement(_Form.default, _extends({
  ...
  var tableProps = _objectSpread(_objectSpread({}, rest), {}, {
    ...
    onChange: function onChange(changePagination, filters, sorter, extra) {
      ...
      setProFilter((0, _proUtils.omitUndefinedAndEmptyArr)(filters)); // 制造一个排序的数据
  ...
  var tableDom = props.tableViewRender ? props.tableViewRender(tableProps) : /*#__PURE__*/_react.default.createElement(_table.default, tableProps);
  /**
  ...
  return /*#__PURE__*/_react.default.createElement(_configProvider.default, {
    ...
    style: style,
    ref: rootRef
  }, isLightFilter ? null : searchNode, type !== 'form' && props.tableExtraRender && /*#__PURE__*/_react.default.createElement("div", {
...
var ProviderWarp = function ProviderWarp(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_container.default.Provider, {
    initialState: props
  }, /*#__PURE__*/_react.default.createElement(_proProvider.ConfigProviderWrap, null, /*#__PURE__*/_react.default.createElement(_ErrorBoundary.default, null, /*#__PURE__*/_react.default.createElement(ProTable, _extends({
