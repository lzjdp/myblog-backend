...
var useFetchData = function useFetchData(getData, defaultData, options) {
  ...
  var _useState5 = (0, _react.useState)({
    page: (options === null || options === void 0 ? void 0 : options.current) || (options === null || options === void 0 ? void 0 : options.defaultCurrent) || 1,
    total: 0,
    pageSize: (options === null || options === void 0 ? void 0 : options.pageSize) || (options === null || options === void 0 ? void 0 : options.defaultPageSize) || 20
  }),
      _useState6 = _slicedToArray(_useState5, 2),
      pageInfo = _useState6[0],
      _setPageInfo = _useState6[1]; // Batching update  https://github.com/facebook/react/issues/14259
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 19:
              ...
              setLoading(false); // 如果没有传递这个方法的话，需要把错误抛出去，以免吞掉错误
  ...
  var fetchListDebounce = (0, _proUtils.useDebounceFn)(fetchList, [], 10);
  /**
   * pageIndex 改变的时候自动刷新
   */
  ...
  return {
    ...
    reset: function reset() {
      _setPageInfo({
        page: (options === null || options === void 0 ? void 0 : options.defaultCurrent) || 1,
        total: 0,
        pageSize: (options === null || options === void 0 ? void 0 : options.defaultPageSize) || 20
      });
    },
