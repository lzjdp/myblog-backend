...
var FieldCode = function FieldCode(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement("pre", _extends({
      style: {
        padding: 16,
        overflow: 'auto',
        fontSize: '85%',
      ...
      ref: ref
    }, fieldProps), /*#__PURE__*/_react.default.createElement("code", null, code));
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (plain) {
      _dom = /*#__PURE__*/_react.default.createElement(_input.default, _extends({}, fieldProps, {
        ref: ref
      }));
    }
...
var _default = _react.default.forwardRef(FieldCode);
